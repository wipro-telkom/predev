...
public final class APIConstants {
    ...
    public static final String API_STORE_LOGIN_USERNAME = "username";
    public static final String API_STORE_LOGIN_PASSWORD = "password";
    public static final String API_STORE_LOGIN_URL = "/site/blocks/user/login/ajax/login.jag";
    public static final String API_STORE_API_LIST_URL = "/site/blocks/api/listing/ajax/list.jag";
    public static final String API_PUBLISHER_LOGIN_URL = "/site/blocks/user/login/ajax/login.jag";
    public static final String API_PUBLISHER_API_LIST_URL = "/site/blocks/listing/ajax/item-list.jag";
    public static final String PAGINATED_PUBLISHED_API_GET_ACTION = "getAllPaginatedPublishedAPIs";
    public static final String API_STORE_USER_SIGNUP_URL = "/site/blocks/user/sign-up/ajax/user-add.jag";
    public static final String ALL_PUBLISHER_API_GET_ACTION = "getAllAPIs";
    public static final String ALL_STORE_API_GET_ACTION = "getAllPaginatedPublishedAPIs";
