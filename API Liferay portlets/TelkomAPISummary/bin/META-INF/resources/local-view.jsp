...
$(document).ready(function(){
		...
		function PopulateAPIs(roleId,categoryId){
			...
			$.ajax({
				  type: "get",
				 url : "http://10.138.30.11:9846/GatewayBridgePlugin/rest/BridgeController/getAllApiData?api=WSO2&cache=true&role=1&category="+categoryId,
				 // url : "http://10.138.30.11:9846/GatewayBridgePlugin/rest/BridgeController/getAllApiData?api=WSO2&cache=true&role="+roleId+"&category="+this.value,
				 contentType: 'application/json',		  
				}).done(
					function(message){
						var datacontent = "";
						for (var i = 0; i < message.data.length; i++) {
							datacontent +="<div class='col-sm-4' ><div class='box'><div><img id='top_img1' class='img-container' src='/o/TelkomAPISummary/Images/sms1.PNG' ></div><div><p id='details_sms'><strong>"+message.data[i].API_Name+"</strong><br/>"+message.data[i].API_Short_Desc+"<br/><div><button type='button' class='btn btn-danger smsmore'>More</button></div></p></div></div></div>";
						}
